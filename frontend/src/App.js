            ...
            <Routes>
              <Route element={<ProtectedRouteCustomer />}>
                ...
                <Route
                  path="/faqs/view/:id"
                  exact
                  element={<FaqViewCustomer />}
                />
                <Route
                  path="/inquiries/view/:id"
                  exact
                  element={<InquiryViewCustomer />}
                />
              ...
              <Route
                path="/Product/Restock"
                exact
                element={<RestockProduct />}
              />
              ...
              />
              <Route
                path="/Supplier/pendingpurchase"
                exact
                element={<ViewPendingPurchase />}
              />
              <Route
              ...
              />
              AdminForm
              <Route path="/Employee/create" exact element={<AdminForm />} />
              <Route path="/Customer" exact element={<Customers />} />
              <Route
                path="/Customer/TopCustomers"
                exact
              ...
              />
              <Route
                path="/Wholesalecustomer/create"
                exact
                element={<CreateWholesalecustomer />}
              />
              <Route
                path="/Wholesalecustomer"
                exact
                element={<Wholesalecustomer />}
              />
              <Route
                path="/Wholesalecustomer/update/:id"
                exact
                element={<UpdateWholesalecustomer />}
              />
              <Route
                path="/Wholesalecustomer/view/:id"
                exact
                element={<ViewWholesalecustomer />}
              />
              <Route
                path="/Wholesalecustomer/report"
                exact
                element={<WholesalecustomerReport />}
              />
              <Route
              ...
              <Route
                path="/Employeelogin/new"
                exact
                element={<Employeeloginform />}
              />
              <Route
                path="/Employeelogin/update/:id"
                exact
                element={<EmployeeloginformUpdate />}
              />
              <Route
                path="/Salaryform"
                exact
                element={<SalaryCalculatorForm />}
              />
              ...
              <Route
                path="/inquiry_admin/view/:id"
                exact
                element={<InquiryViewAdmin />}
              />
              <Route
                path="/inquiry_admin/report"
                exact
              ...
              />
              {/* alias path in lowercase for convenience */}
              <Route
                path="/loginemployee"
                exact
                element={<LoginPageEmployee />}
              />
              <Route
                path="/deliverypersonprofile"
                exact
                element={<DeliveryPersonProfile />}
              />
              <Route
                path="/deliverypersonorder"
                exact
